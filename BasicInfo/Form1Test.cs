...
namespace BasicInfo
{
    ...
    public class Form1Test
    {
        ...
        ///</summary>
        [TestMethod()]
        [DeploymentItem("BasicInformation.exe")]
        ...
        /// <summary>
        ///A test for btndisplay_Click
        ///</summary>
        [TestMethod()]
        [DeploymentItem("BasicInformation.exe")]
        public void btndisplay_ClickTest()
        {
            Form1_Accessor target = new Form1_Accessor(); // TODO: Initialize to an appropriate value
            object sender = null; // TODO: Initialize to an appropriate value
            EventArgs e = null; // TODO: Initialize to an appropriate value
            target.btndisplay_Click(sender, e);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
        ...
        /// <summary>
        ///A test for rtxtshow_TextChanged
        ///</summary>
        [TestMethod()]
        [DeploymentItem("BasicInformation.exe")]
        public void rtxtshow_TextChangedTest()
        {
            Form1_Accessor target = new Form1_Accessor(); // TODO: Initialize to an appropriate value
            object sender = null; // TODO: Initialize to an appropriate value
            EventArgs e = null; // TODO: Initialize to an appropriate value
            target.rtxtshow_TextChanged(sender, e);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
    }
}
